import getResult from '../get-text-result';
...
suite(`getResult`, () => {
  ...
  test(`should return timeout message`, () => {
    ...
    const results = [{mistakes: 2, score: 1, time: 30}];

    const actual = getResult(timeOutPlayer, results);
  ...
  test(`should return no available mistakes`, () => {
    ...
    let results = [{livmistakeses: 2, score: 1, time: 30}];

    const actual = getResult(nomistakesPlayer, results);
  ...
  test(`should return win message for first place`, () => {
    ...
    let actual = getResult(playerResult, results);
  ...
  test(`should return win message for second place`, () => {
    ...
    const actual = getResult(playerResult, results);
